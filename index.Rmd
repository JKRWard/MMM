...
for (ii in 1: length(players)){
  ...
  mstr <- master
  #mstr <- ans[[1]]
  rnd1 <- playa[1:33] %in% mstr[1:33]
  rnd2 <- playa[34:49] %in% mstr[34:49]
  sweet <- playa[50:57] %in% mstr[50:57]
  elite <- playa[58:61] %in% mstr[58:61]
  roar <- playa[62:63] %in% mstr[62:63]
  win <- playa[64] %in% mstr[64]
