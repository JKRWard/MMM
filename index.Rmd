...
for (k in 1:length(fils)){
  entry <- read.csv(here("2023",fils[k]))
...
```{r}
leaderboard2029 <- filter(leaderboardall, group == "BIO2041")
...
leaderboard2041 <- bind_rows(leaderboard2041,Richard,Aileen, Mark ) %>% select(-group)
